(function(scope){
	...
	*/
	...
	var author$project$EmployeeDashboard$Table = F2(
		function (a, b) {
	...
	var author$project$EmployeeDashboard$columnsToStrings = function (cs) {
		return elm$core$List$concat(_List_Nil);
	};
	var author$project$EmployeeDashboard$rowsToStrings = function (rss) {
		return elm$core$List$concat(_List_Nil);
	};
	...
	var author$project$EmployeeDashboard$stringsToHtml = function (xs) {
		return A2(
			elm$html$Html$div,
			_List_Nil,
			A2(
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							author$project$EmployeeDashboard$viewTable(
							A2(
								author$project$EmployeeDashboard$Table,
								_List_fromArray(
									['']),
								_List_fromArray(
									[
